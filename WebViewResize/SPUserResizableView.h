...
#define kSPUserResizableViewGlobalInset 30

#define kSPUserResizableViewDefaultMinWidth 140.0
#define kSPUserResizableViewDefaultMinHeight 120.0
...
- (void)userResizableViewResized:(SPUserResizableView *)userResizableView;
